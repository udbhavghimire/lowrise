  ...
  return (
    <div className="pt-5">
      <footer className="footer mt-5  shadow-lg">
        <div className="">
          <div className="text-center pt-5 brand-bg text-white px-3">
            ...
            <p className="textt">
              ...
              reputable builders across Canada – Lowrise.ca curates the latest
            ...
            <div className="row row-cols-md-3 row-cols-1 d-flex justify-content-around  align-items-center pt-5 ">
              <div className="col-md-6 texttt text-center">
                ...
                <p className="pe-md-5 px-0 ">
                  Note: Lowrise is Canada's one of the largest database of new
                  ...
                  may be outdated or inaccurate. Lowrise Inc. is not liable for
              ...
              <div className="col-md-3 mt-4 pt-5 pt-lg-0 mt-lg-0 footer-contact">
                ...
                <p>
                  <strong>Email:</strong> <span>info@Lowrise.ca</span>
                </p>
              </div>
        ...
        <div className="container copyright text-start text-center py-5">
          <p>
            ...
            <strong className="px-1">Lowrise</strong>{" "}
